...
final class SearchShortcode
{
    public static function render($atts, array $deps)
    {
        ...
        echo '<div class="opentt-search-quick" data-opentt-search-quick hidden></div>';
        echo '<div class="opentt-search-suggestion" data-opentt-search-suggestion hidden></div>';
        echo '<div class="opentt-search-intent" data-opentt-search-intent hidden></div>';
