...
Stoni tenis zaslužuje modernu digitalnu osnovu koja je:
- transparentna,
- proverljiva,
- interoperabilna,
- i održiva kroz veliki broj sezona.

To podrazumeva:
- javno dostupne rezultate,
- istorijske arhive sezona i klubova,
- pregled statistike i učinka,
...
- otvorenom API i pouzdanom export/import sistemu,
- live score i broadcast integracijama,
- alatima za klubove, saveze i organizatore,
- self-host i decentralizovanim načinima rada,
- interoperabilnosti između sistema i sezona,
- dugoročno održivoj arhivi sporta.
...
- koriste softver,
- proučavaju i proveravaju kod,
- menjaju ponašanje sistema prema lokalnim potrebama,
- dele i unapređuju rešenja.

AGPL model licenciranja je nameran:
- štiti softverske slobode,
- čuva obavezu deljenja izvornog koda i kod mrežnih/SaaS primena,
- smanjuje rizik zatvaranja zajedničkog rada u neuzvraćene zatvorene forkove.

Cilj projekta nije vendor lock-in.
Prioritet su transparentnost, interoperabilnost i dugoročna dostupnost podataka.
...
- operaterima liga,
- statističarima,
- i zajednici stonog tenisa u celini.

Osnovna funkcionalnost treba da ostane praktično dostupna bez prisilnih "Pro-only" barijera.
...
- održiv,
- transparentan,
- i operativno prenosiv.

Kako projekat raste, održivost može uključivati:
- javne instance,
- mirror sisteme,
- community maintainere,
- donacije i podršku,
- neprofitne ili javno korisne modele upravljanja.
...
- eksplicitne šeme i ugovore,
- predvidivu eksportabilnost podataka,
- nisku frikciju za netehničke operatere,
- transparentno ponašanje admin i frontend sloja.
...
- da arhiva i export budu funkcije prvog reda,
- smanjenje rizika od tihog gubitka podataka,
- mogućnost praćenja porekla zapisa i izmena.
...
- prenosivi import/export formati,
- API-orijentisana arhitektura,
- predvidivi identifikatori i mapiranje sezone/takmičenja.

Interoperabilnost nije sporedna funkcija, već preduslov dugoročnog opstanka podataka.
...
Ambicija je jasna:
- ne samo upravljanje trenutnim rezultatima,
- već očuvanje otvorene digitalne istorije sporta,
- i njena dostupnost budućim generacijama.
...
- istorijske arhive sezona i rezultata,
- statistiku, rang liste i međusobne duele,
- dugoročno očuvanje sportskih podataka,
- otvoren i transparentan pristup informacijama,
- povezivanje klubova, operatera i zajednice kroz zajedničku infrastrukturu.
...
- otvorene API-je i data export,
- live score i broadcast integracije,
- istorijske statistike i arhive,
- interoperabilnost između klubova i organizatora,
- decentralizovane ili self-hosted implementacije.

Vizija projekta je da podaci i istorija stonog tenisa ostanu dostupni, proverljivi i održivi dugoročno, nezavisno od pojedinačnih platformi, sezona ili administratora.
...
Serveri, backup sistemi, skladištenje, bandwidth, monitoring i dugoročno čuvanje podataka zahtevaju resurse, posebno kroz veliki broj sezona i istorijskih zapisa.

Istovremeno, projekat eksplicitno odbacuje pristup u kome je osnovna sportska infrastruktura zaključana iza zatvorenih sistema ili prisilnih paywall modela.

Filozofija projekta je:
- infrastruktura može imati trošak,
- ali osnovni pristup podacima, istoriji i zajedničkom znanju treba da ostane dostupan zajednici.
...
- zajednica može nastaviti projekat nezavisno od jednog servera ili maintainera.

Održivost infrastrukture može uključivati:
- donacije zajednice,
- podršku klubova i organizatora,
- grantove i javne programe,
- sponzorstva,
- community maintainere,
- neprofitne modele upravljanja,
- mirror i decentralizovane instance.
...
- AGPL licenca,
- import/export tokovi,
- otvoreni formati podataka,
- self-host mogućnosti,
- interoperabilnost,
- dokumentacija i transparentna arhitektura.

### 12.3 Dugoročni cilj očuvanja

Vizija nije samo funkcionalan servis za trenutnu sezonu.
...
- školska takmičenja,
- regionalne saveze,
- privatne statističke instance,
- eksperimentisanje i prototipizaciju,
- backup/mirror sisteme,
- i dugoročnu otpornost ekosistema.

Dodatni razlozi su:
- lokalna kontrola nad pravilima i politikom podataka,
- prilagođeni workflow-i za specifične zajednice,
- nezavisan tempo izdanja i promena,
- specifične integracije po okruženju,
- operativni kontinuitet kada centralna infrastruktura ima prekid ili organizacionu tranziciju.

Ekosistem je snažniji kada javni centralni sloj i nezavisne self-host instance koegzistiraju.
To nije dupliranje, već otpornost ugrađena u sam dizajn projekta.
...
- i infrastrukturi koja može nadživeti pojedinačne maintainere.

Projekat treba da bude koristan danas i pouzdan decenijama unapred.
