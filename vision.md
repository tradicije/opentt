...
Table tennis deserves a modern digital foundation that is:
- transparent,
- auditable,
- interoperable,
- and sustainable over many seasons.

That includes:
- publicly accessible results,
- historical archives of seasons and clubs,
...
- open API and robust import/export pipelines,
- live score and broadcasting integrations,
- operational tooling for clubs, federations, and organizers,
- self-hostable and decentralized deployment options,
- interoperability across systems and seasons,
- durable archival continuity across generations.
...
- use the software,
- inspect and verify the code,
- modify behavior for local needs,
- share improvements.

The AGPL licensing model is intentional:
- it protects software freedoms,
- it preserves source-sharing obligations in network/SaaS usage,
- it helps prevent extraction of community value into closed forks without reciprocity.

The project is explicitly anti-lock-in.
Its priority is openness, interoperability, and long-term availability of sports data.
...
- federations,
- statisticians,
- and the broader table tennis community.

The functional core should remain practically accessible without forced "Pro-only" barriers.
...
As the project grows, sustainability models may include:
- public instances,
- mirrors,
- distributed maintainers,
- donations/support,
- nonprofit or public-interest stewardship structures.
...
- predictable exportability,
- minimal friction for non-technical operators,
- transparent behavior in both admin and frontend layers.
...
- making archive and export workflows first-class,
- reducing risk of silent data loss,
- enabling traceable provenance of records.
...
- predictable identifiers and season/competition mapping.

Interoperability is not a side feature; it is core to long-term survival of sports data.
...
- not only to manage current results,
- but to preserve an open digital history of the sport,
- and keep that history accessible to future generations.
...
- historical archives of seasons and results,
- statistics, rankings, and head-to-head records,
- long-term preservation of sports data,
- open and transparent access to information,
- connection between clubs, operators, and community through shared infrastructure.
...
- open APIs and data export pathways,
- live score and broadcast integrations,
- historical statistics and archives,
- interoperability between clubs and organizers,
- decentralized or self-hosted implementations.

The long-term direction is clear: table tennis data and history should remain accessible, verifiable, and sustainable beyond any single platform, season, or administrator.
...
Servers, backups, storage, bandwidth, monitoring, and long-term preservation all require ongoing resources, especially across many seasons and historical records.

At the same time, the project explicitly rejects the idea that core sports infrastructure should be locked behind closed systems or forced paywall models.

The project philosophy is:
- infrastructure may have costs,
- but core access to data, history, and shared knowledge should remain available to the community.
...
- the community can continue operations independently of any single server or maintainer.

Infrastructure sustainability can include:
- community donations,
- club and organizer support,
- grants and public-interest programs,
- sponsorships,
- community maintainers,
- nonprofit stewardship models,
- mirror and decentralized instances.
...
- documentation and transparent architecture.

### 12.3 Long-Term Preservation Goal

The vision is not only a functional service for the current season.
...
- private statistical instances,
- experimentation and feature prototyping,
- backup/mirror systems,
- and long-term ecosystem resilience.

Additional reasons include:
- local governance and data policy control,
- custom workflows for specific communities,
- independent release pacing,
- environment-specific integrations,
- operational continuity during central outages or organizational transitions.

The ecosystem is stronger when a public central layer and independent self-hosted layers coexist.
That coexistence is not duplication; it is resilience by design.
...
- and infrastructure that can outlast individual maintainers.

The project should remain useful today, and still trustworthy decades from now.
