    ...
    private static function shortcode_catalog()
    {
        return [
            ...
            [
                ...
                'attrs' => 'columns, limit, klub, played, liga, season, filter, infinite, opentt_match_date',
                'details' => 'Najčešći shortcode za listing utakmica na početnoj ili liga stranici. Kada je `filter=true`, desno prikazuje izbor gustine prikaza (`Prostrano`/`Kompaktno`) i kalendar sa obojenim danima: odigrane (zeleno), predstojeće (plavo).',
                'builder' => [
