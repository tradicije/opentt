...
JS;
    ...
    private static function shortcode_catalog()
    {
        return [
            ...
            ['tag' => 'opentt_featured_player', 'desc' => 'Istaknuta kartica najboljeg igrača (kontekstualno ili ručni izbor).', 'attrs' => 'igrac, klub, liga, sezona, title', 'details' => 'Ako je prosleđen `igrac`, prikazuje tačno tog igrača. Ako je prosleđen `klub` (ili single-klub kontekst), prikazuje najbolje rangiranog igrača tog kluba sa aktuelne rang liste.', 'builder' => [['name' => 'igrac', 'label' => 'Igrač slug/ID', 'type' => 'text', 'default' => ''], ['name' => 'klub', 'label' => 'Klub slug/ID', 'type' => 'text', 'default' => ''], ['name' => 'liga', 'label' => 'Liga slug', 'type' => 'text', 'default' => ''], ['name' => 'sezona', 'label' => 'Sezona slug', 'type' => 'text', 'default' => ''], ['name' => 'title', 'label' => 'Naslov sekcije', 'type' => 'text', 'default' => '']]],
